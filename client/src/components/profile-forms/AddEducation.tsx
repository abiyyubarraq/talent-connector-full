...
const AddEducation: React.FC<any> = ({ addEducation }) => {
  ...
  return (
    <section className="container">
      ...
      >
        ...
        <div className="form-group">
          <textarea name="description" cols={30} rows={5} placeholder="Program Description" value={description} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setFormData({ ...formData, [e.target.name]: e.target.value })} />
        </div>
